...
```assembly
.section .data
num1: .word 20       // Primer número (dividendo)
num2: .word 5        // Segundo número (divisor)
output_msg: .asciz "El resultado de la división es: " // Mensaje de salida
newline: .asciz "\n"  // Salto de línea
...
_start:
    // 1. Cargar los números en registros
    LDR w0, =num1          // Cargar dirección de num1
    LDR w0, [w0]           // Cargar el valor de num1 en w0
    LDR w1, =num2          // Cargar dirección de num2
    LDR w1, [w1]           // Cargar el valor de num2 en w1

    // 2. Dividir los números
    SDIV w2, w0, w1        // w2 = num1 / num2 (cociente)

    // 3. Llamada al sistema para escribir el mensaje de salida
    ...
    // 4. Convertir el valor en w2 a ASCII y mostrarlo
    MOV w0, w2             // Mover el valor de la división a w0
