...
output_msg: .asciz "El valor mínimo en el arreglo es: "
newline: .asciz "\n"                  // Salto de línea
...
_start:
    ...
    LDR w1, [x0]                      // Primer elemento del arreglo en w1 (valor inicial mínimo)
    LDR x2, =array_size               // Dirección del tamaño del arreglo
    LDR w2, [x2]                      // Tamaño del arreglo en w2

    // 2. Iterar sobre el arreglo para encontrar el mínimo
find_min:
    ...
    CMP w3, w1                        // Comparar el valor en w3 con el valor mínimo en w1
    BHS find_min                      // Si w3 es mayor o igual a w1, continuar
    MOV w1, w3                        // Si w3 es menor, actualizar el mínimo en w1
    B find_min                        // Repetir el ciclo
...
print_result:
    ...
    // 4. Convertir el valor mínimo en w1 a ASCII y mostrarlo
    MOV w0, w1                        // Mover el valor mínimo a w0
