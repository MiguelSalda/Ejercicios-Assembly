...
.section .data
output_msg:
    .asciz "El resultado de la resta es: "  // Mensaje de salida
newline:
    .asciz "\n"                           // Salto de línea
...
_start:
    ...
    MOV w0, #15           // Primer número: 15
    MOV w1, #7            // Segundo número: 7
    SUB w2, w0, w1        // w2 = w0 - w1 (15 - 7 = 8)
    ...
    // 3. Convertir el resultado (w2) a ASCII y mostrarlo
    MOV w0, w2            // Mover el resultado de la resta (8) a w0
